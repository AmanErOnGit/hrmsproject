...
import 'package:hrmsapp/support/ExpandedSection.dart';
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          label: RichText(
            text: TextSpan(text: label, style: const TextStyle(color: Colors.black87), children: [TextSpan(text: isMandatory ? " *" : "", style: const TextStyle(color: Colors.red))]),
          ),
...
Color? cursorColor,
        ...
        decoration: InputDecoration(
          ...
          label: label??RichText(
            text: TextSpan(children: [
              TextSpan(text: labelTextNew, style: const TextStyle(color: AppColor.primary, fontSize: 15)),
              if (isMandatory) const TextSpan(text: " *", style: TextStyle(color: AppColor.negativeButton, fontSize: 16))
            ]),
          ),
          hintText: hintText,
          ...
          enabledBorder: OutlineInputBorder(borderRadius:BorderRadius.circular(5), borderSide:  BorderSide(color: enableBorder?Colors.grey.shade400:Colors.white)),
          focusedBorder:OutlineInputBorder(borderRadius: BorderRadius.circular(5), borderSide:  BorderSide(color: enableBorder?Colors.grey.shade400:Colors.white)),
          disabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(5), borderSide:  BorderSide(color:enableBorder? Colors.grey.shade300:Colors.white)),
        ),
      ),
    );
  }

  static Widget outlineElevatedCustomButton(String? buttonName, void Function()? onTapFunction, {double? heightButton, double? horizontal, bool iconEnable = false}) {
    return Padding(
  ...
  static elevatedCustomButton(context, String s, Function() param1,
      {double? width, Color bgColor = AppColor.secondary, IconData? icon, Color? iconColor, Color textColor = Colors.white, Color borderColor = AppColor.secondary,double borderRadius=8,FontWeight? weight=FontWeight.w400}) {
    return SizedBox(
  ...
  void getBottomSheetForProfile(BuildContext context, Function() onTapCamera, Function() onTapGallery) {
                ...
                children: [
                  ...
                  Expanded(
                    child: GestureDetector(
                      ...
                      child: Column(
                        children: [
                          Icon(Icons.image_rounded, color: Colors.blue.shade800, size: 28),
                          const Text(
                            "Gallery",
                            style: TextStyle(color: Colors.black, fontSize: 18.0, fontWeight: FontWeight.normal),
                          ),
  ...
  static Widget modelDropDown(Shops value, List<Shops> itemList, void Function(dynamic?)? onChange,
        ...
        Container(
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton<Shops>(
              ...
              items: itemList.map<DropdownMenuItem<Shops>>((Shops items) {
  ...
  Future<String> selectTime(BuildContext context, {bool? isTFhour = false}) async {
    ...
    final TimeOfDay? timeOfDay = await showTimePicker(
        ...
        builder: (BuildContext context, Widget? child_1) {
          return MediaQuery(data: MediaQuery.of(context).copyWith(alwaysUse24HourFormat: isTFhour), child: child_1!);
        });
    if (isTFhour!) {
      if (timeOfDay != null) {
  ...
  static Future<DateTimeRange> pickDateRange(BuildContext context, {required String backDate, DateTime? firstDate, DateTime? lastDate}) async {
  ...
  static Widget stringTypeDropDown(String value, List<String> itemList, void Function(String?)? onChange, FocusNode? focusNode,
      {Color? colorDropDown, String label = "", isMandatory = false, applyFitted = true, BuildContext? context, bool hideLabel = false, bool hideBorder = false}) {
    return Stack(
      children: [
        Container(
          height: 48,
  ...
  getCustomDataTable(BuildContext context, List<String> headerValue, List<String> actionList, List<String> headerkeys, List<Map<String, dynamic>> data, Function(int index) actionView) {
    ...
    return DataTable(
      ...
      headingRowColor: WidgetStateColor.resolveWith((states) => AppColor.secondary),
  ...
  getCustomDataTableType2(BuildContext context, List<String> headerValue, List<String> actionList, List<String> headerkeys, List<Map<String, dynamic>> data) {
    ...
    return DataTable(
      ...
      horizontalMargin: 4,
      decoration: BoxDecoration(border: Border.all(width: 1, color: Colors.grey), color: Colors.white),
      headingRowColor: MaterialStateColor.resolveWith((states) => AppColor.secondary),
      columns: [
  ...
  static getCustomTextField(
      TextEditingController controller, FocusNode? focus, String label, bool isMantory, String? unit, List<TextInputFormatter> inputFormatters, Function(String value) onChange,
      {bool? readOnly = false, bool labelOnTop = true}) {
    return Column(
            ...
            children: [
              ...
              if (unit != null)
                Container(
                  ...
                  padding: const EdgeInsets.symmetric(horizontal: 10),
                  decoration: BoxDecoration(
                      borderRadius: const BorderRadius.horizontal(right: Radius.circular(8)), border: const BorderDirectional(start: BorderSide(color: Colors.black)), color: Colors.grey.shade200),
                  child: Text(
                    "$unit",
